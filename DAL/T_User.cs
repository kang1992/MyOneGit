...
namespace 第三学期三层构架_新闻管理_.DAL
{
	...
	public partial class T_User
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(第三学期三层构架_新闻管理_.Model.T_User model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_User(");
			strSql.Append("UserId,UserName,Password,RealName,Mobile,Department)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(第三学期三层构架_新闻管理_.Model.T_User model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public 第三学期三层构架_新闻管理_.Model.T_User GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,UserId,UserName,Password,RealName,Mobile,Department from T_User ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			第三学期三层构架_新闻管理_.Model.T_User model=new 第三学期三层构架_新闻管理_.Model.T_User();
		...
		/// 得到一个对象实体
		/// </summary>
		public 第三学期三层构架_新闻管理_.Model.T_User DataRowToModel(DataRow row)
		{
			第三学期三层构架_新闻管理_.Model.T_User model=new 第三学期三层构架_新闻管理_.Model.T_User();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,UserId,UserName,Password,RealName,Mobile,Department ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,UserId,UserName,Password,RealName,Mobile,Department ");
			strSql.Append(" FROM T_User ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
